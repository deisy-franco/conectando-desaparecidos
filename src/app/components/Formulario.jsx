...
export default function Formulario({datos, handleChange, handleImageUpload}){
    ...
    return(
        <form 
            id="formulario-ficha"
            style={{flex:'1', minWidth:'300px',backgroundColor: '#f8fafc',padding:'1.5rem', borderRadius: '10px'}}
        >
            <h2><strong>Ingresa los datos</strong></h2>
            <ul>
                <li><strong>Nombre completo:</strong>
                    {/* Se agregó "required" al final de cada input */}
            ...
            <ul>
                <li><strong>Correo electronico:</strong>
                    {/* ✨ Opcional: Cambié el tipo de texto a "email" para que el navegador verifique que lleve un @ */}
