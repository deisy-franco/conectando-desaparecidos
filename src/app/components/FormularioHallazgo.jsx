...
// ✨ 1. RECIBIMOS LA NUEVA FUNCIÓN 'handleSubmit'
            ...
            <ul>
                ...
                <li><strong>Fotos del hallazgo</strong>
                    <input 
                        type="file" 
                        multiple 
                        required // ✨ Agregado para obligar a subir al menos una foto
                        accept="image/*" 
                ...
                <li>
                    {/* Este botón ya tiene type="submit", así que disparará las validaciones automáticamente */}
                    ...
                    onClick={(e) => {
                            if (!usuario.id) {
                                // 1. Le ponemos nuestro mensaje de error personalizado al botón
                                e.currentTarget.setCustomValidity('Debes iniciar sesión para poder publicar');
                                // 2. Obligamos al navegador a mostrar su alerta nativa
                                e.currentTarget.reportValidity();
                                // 3. Detenemos el envío
                                e.preventDefault(); 
                            } else {
                                // Si está logueado, limpiamos cualquier error anterior para que funcione normal
