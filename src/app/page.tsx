...
export default function Inicio() {
    ...
    return (
        <div style={{ backgroundColor: '#050505', minHeight: '100vh', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* ================= SECCIÓN 1: HERO (Fondo Sólido + Imagen separada) ================= */}
            <div style={{
                backgroundColor: '#050505', // ✨ El fondo ahora es 100% negro sólido
                width: '100%',
                minHeight: '350px',
                borderRadius: '24px',
                display: 'flex',
                ...
                color: 'white',
                flexWrap: 'wrap' // Permite que se acomode automáticamente en celulares
            }}>
                ...
                <div style={{ flex: '1 1 50%', position: 'relative', minHeight: '350px', minWidth: '300px' }}>
                    ...
                    {/* Un pequeño difuminado opcional para que la foto se una suavemente con el negro sólido */}
                    <div style={{ 
                        position: 'absolute', 
                        top: 0, 
                        left: 0, 
                    ...
                    {/* ✨ La imagen ya no es fondo, es un elemento propio */}
                    <img 
            ...
            {/* ================= SECCIÓN 2: ACCIONES RÁPIDAS (Tarjeta Blanca) ================= */}
            <div style={{
